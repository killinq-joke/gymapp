...
export default function Account() {
  ...
  return (
    <>
    <Icon style={{margin: "5% 0 0 2%"}} icon={arrowLeftShort} width="40" height="40"/>
      ...
      <div><p>My Height</p><p>{height}cm</p><input type="range" min="100" max="250" onChange={e => setHeight(e.target.value)}/></div>
    </>
  );
}
